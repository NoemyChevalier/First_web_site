...
function generatePDF($table, $filename, $pdf, $fields)
{
    ...
    $pdf->SetTitle("Compétitions à venir");

    $pdf->Cell(0, 10, "Competitions a venir", 0, 1, 'C');
    $pdf->Ln(10);
...
generatePDF('competition', 'Competitions.pdf', $pdf, ['lieu_competition', 'date_competition', 'duree_competitions', 'type_competition']);

...
function generatePDF($table, $filename, $pdf, $fields)
{
    ...
    $pdf->Cell(0, 10, "Entrainement a venir", 0, 1, 'C');
    $pdf->Ln(10);
...
// Appeler la fonction pour la table 'entrainement' avec des champs spécifiques
generatePDF('entrainement', 'Entrainements.pdf', $pdf, ['lieu_entrainement', 'horaire_entrainement']);

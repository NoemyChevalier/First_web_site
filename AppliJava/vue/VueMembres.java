...
public class VueMembres {
    public void afficher() {
        ...
        // Titre
        JLabel compet = new JLabel("Liste des membres");
        ...
        List<String[]> adherents = connexionAdmin.getAdherents();

        String[] nomColonnes = {"Nom", "Prénom", "Age", "email", "Numéro de téléphone"};
        Object[][] data = adherents.toArray(new Object[0][]);

        JTable table = new JTable(data, nomColonnes);
